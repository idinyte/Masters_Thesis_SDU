...
\begin{figure}[ht]
  ...
  \begin{subfigure}{\textwidth}
    \centering
  \includegraphics[width=0.8\linewidth]{chapters/exoskeleton/images/genetic_algorithm/testing_ball_switching.png}
  \caption{Current}
  \end{subfigure}
  \centering
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{chapters/exoskeleton/images/genetic_algorithm/testing_pwm_switching.png}
    \caption{PWM}
  \end{subfigure}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\linewidth]{chapters/exoskeleton/images/current/current_control.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\linewidth]{chapters/exoskeleton/images/current/squeezing_ball_5_times.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\linewidth]{chapters/exoskeleton/images/current/smoothed_curves.png}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{\textwidth}
    \centering
  \includegraphics[width=0.8\linewidth]{chapters/exoskeleton/images/current/No_smoothing.png}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{chapters/exoskeleton/images/current/smoothing_k10.png}
    \caption{Target current exponential smoothing with k=10}
    \label{fig:current_smoothing}
  \end{subfigure}
  \caption{Comparison of smoothing and no smoothing in target current}
